  ...
  \cventry
    ...
    {2020 年 2 月至今} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item 为了更好地满足市场需要，扩大产品受众，传播公司的技术影响力，负责公司机器学习平台开源工作组的工作。组织周会，协调利益相关方共同推进机器学习平台产品的开源社区版工作。目前这一工作还在进行中，将于 2020 下半年开源推理平台。
        ...
        \item 为了提高集群加速器资源的利用率，满足客户需求，参与实现 GPU 共享产品特性。支持多个 Pod 共享使用 GPU 资源并且提供一定程度的显存隔离，同时能够与现有监控系统集成，对单个容器进行显存使用情况的监控。在其中主要参与需求分析，系统设计工作。
